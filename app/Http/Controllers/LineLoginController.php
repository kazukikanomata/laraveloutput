...
class LineLoginController extends Controller
{
  ...
  public function lineLogin()
  {
      ...
      $client_id = "&client_id=1657118232";
      $redirect_uri ="&redirect_uri=https://kazu-focus.xyz/callback";
    ...
    public function getAccessToken($req)
    {
      ...
      $post_data = array(
        ...
        'code'          => $req['code'],
        'redirect_uri'  => 'https://kazu-focus.xyz/callback',
        'client_id'     =>  '1657118232',
        'client_secret' => '9097d499cac03c406d4991001429c3aa',
      );
